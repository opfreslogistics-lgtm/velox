  ...
  return (
    <div className="bg-white dark:bg-brand-black min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-10 py-12 space-y-6 text-gray-700 dark:text-gray-300">
        <p>By using Velox Logistics services you agree to our service terms, liability limits, and acceptable use policies.</p>
        ...
        <p>For full legal language, reach out to legal@veloxlogistics.com.</p>
      </div>
    </div>
  );
}
